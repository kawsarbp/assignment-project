        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 my-3">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Security and Reliability</h5>
                ...
                <div class="col-lg-6 my-3">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Convenient and User-Friendly Platform</h5>
                ...
                <div class="col-lg-6 my-3">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Competitive Rates and Fees</h5>
                ...
                <div class="col-lg-6 my-3">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Excellent Customer Support</h5>
