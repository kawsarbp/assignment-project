...
<footer id="footer" class="py-5">
    <div class="container">
        ...
        <div class="mt-3 footer_des">
            "Tap & Pay UK Limited a company incorporated in England with registered number 12908949, FCA 940156 at 49 Boston Road, London, England, W7 3SH. Tap & Pay UK Limited is registered with FCA as PSD agent, FRN 719227 under Worldwide West 2 East services Limited, trading as WORLDWIDE SERVICES (The Principal). Worldwide Services FRN in FCA register is 563795 with company registration no 07684314 at Midsummer Court, 314 Midsummer Boulevard, 203-5, Central Milton Keynes, Milton Keynes, MK9 2UB."
        </div>
    </div>
</footer>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 text-center text-lg-end">
                <div class="text-white text-capitalize">&copy; Copyright QuickSend Money Transfer. All Rights Reserved</div>
            </div>
        ...
        <div class="whatsappimg-box">
            <a href="#">
                <img src="{{ asset('assets/img/whatsappchat.png') }}" class="whatsappimg" alt="">
            </a>
        </div>
    </div>
</div>
